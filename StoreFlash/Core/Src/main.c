...
// stack dung luu dia chi chuong trinh, bien cuc bo, Vùng nhớ được cấp phát khi chương trình được biên dịch.
// Heap dung luu cac mang, cacs bien duoc cap phat Dynamic memory allocation,Vùng nhớ được cấp phát khi chạy chương trình (run-time).
/* USER CODE END PTD */
